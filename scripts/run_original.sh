...
python src/evaluate.py --pred "$OUT/sdnp_results.csv" --labels "$LABELS" --output "$OUT/"
python src/report_case.py --manifest "$OUT/manifest.csv" --pred "$OUT/sdnp_results.csv" --output "$OUT/"
